...
export default function FullScreenModal() {
  ...
  return (
    <ComponentCard title="Full Screen Modal">
      ...
      >
        <div className="fixed top-0 left-0 flex flex-col justify-between w-full h-screen p-6 overflow-x-hidden overflow-y-auto bg-white lg:p-10">
          <div>
            <h4 className="font-semibold text-gray-800 mb-7 text-title-sm ">
              Modal Heading
            </h4>
