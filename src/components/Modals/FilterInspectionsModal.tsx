...
const inspectionStatusOptions: option[] = [
    { label: 'COMPLETE', id: '1' },
...
const deliveredOptions: option[] = [
    { label: 'Yes', id: '1' },
    { label: 'No', id: '2' },
]

const filterOptionsMap: filterOptionsMap = {
...
const FilterInspectionsModal: React.FC<{ onClose: () => void, isOpen: boolean }> = ({ onClose, isOpen }) => {
    ...
    const filteredOptions = unitIdOptions.filter((option) =>
    ...
    const currentOptions = filterOptionsMap[activeFilter] || [];
