...
export const reviewFilterOptions: FilterOption[] = [
    { label: 'Unit ID', key: 'unitId' },
    { label: 'Inspection Status', key: 'inspectionStatus' },
    // { label: 'Vendor', key: 'vendor' },
...
export const missingDataOptions: option[] = [
    { id: 'none', label: 'None' },
    { id: 'incomplete_image_file', label: 'Incomplete Image File' },
    { id: 'incomplete_dot_form', label: 'Incomplete DOT Form' },
    { id: 'incomplete_checklist', label: 'Incomplete Checklist' },
];

export const emailNotificationOptions: option[] = [
    { id: 'no', label: 'No' },
    { id: 'yes', label: 'Yes' },
    { id: 'manually_sent', label: 'Manually Sent' },
];
