...
interface ButtonProps {
  ...
  type?: ButtonType; // Button type (submit, button, reset)
}
...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary:
      "bg-gradient-to-r from-[#312E81] to-[#7E22CE] text-white shadow-theme-xs hover:bg-brand-600 disabled:bg-brand-300",
    outline:
